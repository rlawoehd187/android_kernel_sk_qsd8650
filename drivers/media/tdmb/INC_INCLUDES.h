...
typedef unsigned long		INC_FIXED_FLOAT;	// quotient(20 bits), mantissa(12 bits)

#define FIXED_MANTISSA_BITS	12
#define	mINT_TO_FIXED(a)	( (INC_FIXED_FLOAT)(a) << FIXED_MANTISSA_BITS )
#define	mFLOAT_TO_INT(a)	( (INC_FIXED_FLOAT)(a) >> FIXED_MANTISSA_BITS )

#define FIXED_FLOAT_1_0		( 1 << FIXED_MANTISSA_BITS )
